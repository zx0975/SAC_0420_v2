...
class Sensor:
    ...
    def __init__(self): 
        ...
        # self.r_force_sensor='/r_force_sensor'
        # self.l_force_sensor='/l_force_sensor'
        # rospy.init_node("ft_sensor")
        # self.force=[]
        self.force = []
        self.torque = []
        ...
        # self.r_torque = []
        # self.l_torque = []
        # rospy.init_node("ft_normalized")
        # rospy.Subscriber("sensor_data", WrenchStamped,self.normalize)
        # self.ft_out = rospy.Publisher("normalized_data", WrenchStamped)
        # self.force_vec_out = rospy.Publisher('ft_force_vector', Marker)
